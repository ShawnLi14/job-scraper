...
FIRMS: list[Firm] = [
    ...
    # ---- Well-funded / top-VC startups (verified boards) ----
    # AI products & research labs
    Firm("Gimlet", "ashby", {"board": "gimlet"}),
    Firm("Factory", "ashby", {"board": "factory"}),
    Firm("Forus", "ashby", {"board": "forus"}),
    Firm("Higgsfield", "ashby", {"board": "higgsfieldai"}),
    Firm("Midjourney", "ashby", {"board": "midjourney"}),
    Firm("Luma AI", "ashby", {"board": "lumaai"}),
    Firm("Suno", "ashby", {"board": "suno"}),
    Firm("Udio", "greenhouse", {"board": "udio"}),
    Firm("Gamma", "ashby", {"board": "gamma"}),
    Firm("Granola", "ashby", {"board": "granola"}),
    Firm("Descript", "greenhouse", {"board": "descript"}),
    Firm("Abridge", "ashby", {"board": "abridge"}),
    Firm("Ambience Healthcare", "ashby", {"board": "ambiencehealthcare"}),
    Firm("Commure", "ashby", {"board": "commure"}),
    Firm("Infinitus", "ashby", {"board": "infinitus"}),
    Firm("Insitro", "ashby", {"board": "insitro"}),
    Firm("Generate Biomedicines", "greenhouse", {"board": "generatebiomedicines"}),
    Firm("Recursion", "greenhouse", {"board": "recursionpharmaceuticals"}),
    Firm("Absci", "ashby", {"board": "absci"}),

    # AI infra / cloud / security
    Firm("Crusoe", "ashby", {"board": "crusoe"}),
    Firm("Chainguard", "greenhouse", {"board": "chainguard"}),
    Firm("Socket", "ashby", {"board": "socket"}),
    Firm("Endor Labs", "greenhouse", {"board": "endorlabs"}),
    Firm("Orca Security", "greenhouse", {"board": "orcasecurity"}),
    Firm("HiddenLayer", "greenhouse", {"board": "hiddenlayer"}),
    Firm("PlanetScale", "greenhouse", {"board": "planetscale"}),
    Firm("SingleStore", "greenhouse", {"board": "singlestore"}),
    Firm("Materialize", "ashby", {"board": "materialize"}),
    Firm("Starburst", "greenhouse", {"board": "starburst"}),
    Firm("PostHog", "ashby", {"board": "posthog"}),
    Firm("LaunchDarkly", "greenhouse", {"board": "launchdarkly"}),
    Firm("Hightouch", "greenhouse", {"board": "hightouch"}),
    Firm("WorkOS", "ashby", {"board": "workos"}),
    Firm("Clerk", "ashby", {"board": "clerk"}),
    Firm("Stytch", "ashby", {"board": "stytch"}),
    Firm("Drata", "ashby", {"board": "drata"}),
    Firm("Secureframe", "ashby", {"board": "secureframe"}),
    Firm("Kong", "ashby", {"board": "kong"}),
    Firm("Postman", "greenhouse", {"board": "postman"}),
    Firm("Fastly", "greenhouse", {"board": "fastly"}),
    Firm("Axiom", "greenhouse", {"board": "axiom"}),

    # Fintech / B2B SaaS unicorns
    Firm("Zip", "ashby", {"board": "zip"}),
    Firm("Rho", "ashby", {"board": "rho"}),
    Firm("Meow", "ashby", {"board": "meow"}),
    Firm("Justworks", "greenhouse", {"board": "justworks"}),
    Firm("Bill.com", "greenhouse", {"board": "billcom"}),
    Firm("Melio", "greenhouse", {"board": "melio"}),
    Firm("Checkr", "greenhouse", {"board": "checkr"}),
    Firm("Persona", "ashby", {"board": "persona"}),
    Firm("Sardine", "ashby", {"board": "sardine"}),
    Firm("Middesk", "ashby", {"board": "middesk"}),
    Firm("Lithic", "greenhouse", {"board": "lithic"}),
    Firm("Gong", "greenhouse", {"board": "gongio"}),
    Firm("Apollo.io", "greenhouse", {"board": "apolloio"}),
    Firm("Dialpad", "greenhouse", {"board": "dialpad"}),
    Firm("Merge", "ashby", {"board": "merge"}),
    Firm("Finch", "ashby", {"board": "finch"}),
    Firm("NerdWallet", "ashby", {"board": "nerdwallet"}),
    Firm("Alpaca", "greenhouse", {"board": "alpaca"}),
    Firm("Alchemy", "ashby", {"board": "alchemy"}),
    Firm("Fireblocks", "greenhouse", {"board": "fireblocks"}),
    Firm("BitGo", "greenhouse", {"board": "bitgo"}),
    Firm("Elliptic", "ashby", {"board": "elliptic"}),
    Firm("Consensys", "greenhouse", {"board": "consensys"}),
    Firm("Magic Eden", "ashby", {"board": "magiceden"}),
    Firm("OpenSea", "ashby", {"board": "opensea"}),
    Firm("Corgi", "ashby", {"board": "corgi"}),

    # Robotics / energy / defense-tech
    Firm("1X Technologies", "ashby", {"board": "1x"}),
    Firm("Apptronik", "greenhouse", {"board": "apptronik"}),
    Firm("Agility Robotics", "greenhouse", {"board": "agilityrobotics"}),
    Firm("Osmo", "ashby", {"board": "osmo"}),
    Firm("Form Energy", "ashby", {"board": "formenergy"}),
    Firm("Helion", "ashby", {"board": "helion"}),
    Firm("Redwood Materials", "greenhouse", {"board": "redwoodmaterials"}),
    Firm("Epirus", "greenhouse", {"board": "epirus"}),
    Firm("Vannevar Labs", "greenhouse", {"board": "vannevarlabs"}),
    Firm("Primer AI", "ashby", {"board": "primer"}),
